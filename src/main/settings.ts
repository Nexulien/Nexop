...
export const Settings = loadSettings<TSettings>(SETTINGS_FILE, "Nexop settings");

export const VencordSettings = loadSettings<any>(VENCORD_SETTINGS_FILE, "Nexop settings");
...
export const State = loadSettings<TState>(STATE_FILE, "Nexop state");
